      ...
      <form method="POST" action="{{ route('staff.cars.update', $car->id) }}" enctype="multipart/form-data">
        ...
        <div class="row g-3">
          ...
          <div class="col-md-6">
            ...
            <input type="number" name="initial_mileage" class="form-control @error('initial_mileage') is-invalid @enderror" value="{{ old('initial_mileage', $car->initial_mileage ?? 0) }}" min="0" required>
          ...
          <div class="col-md-6">
            ...
            <select name="service_mileage_limit" class="form-select @error('service_mileage_limit') is-invalid @enderror" required>
              <option value="">Select...</option>
              <option value="2000" {{ old('service_mileage_limit', $car->service_mileage_limit ?? '') == '2000' || old('service_mileage_limit', $car->service_mileage_limit ?? '') == 2000 ? 'selected' : '' }}>2,000 km</option>
              <option value="5000" {{ old('service_mileage_limit', $car->service_mileage_limit ?? '') == '5000' || old('service_mileage_limit', $car->service_mileage_limit ?? '') == 5000 ? 'selected' : '' }}>5,000 km</option>
              <option value="10000" {{ old('service_mileage_limit', $car->service_mileage_limit ?? '') == '10000' || old('service_mileage_limit', $car->service_mileage_limit ?? '') == 10000 ? 'selected' : '' }}>10,000 km</option>
            </select>
